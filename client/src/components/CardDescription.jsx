...
export const CardDataDescription = ({
  tags,
  image,
  comments,
  description,
  ...
  const handleCardToggle = (id) => {
    switch (id) {
      ...
      case 3:
        return handleLabels;
      default:
        return [setCover(false), setLabels(false), setMembers(false)];
    }
  };
  /*
        ...
        <div className="Details">
          <div className="Content">
            <div className="titleHolder">
              <h2 className="CardDestailTitle">{title}</h2>
            ...
            {DescriptionData === true ? (
              ...
              <>
                ...
                <div className="desciptionBtns">
                  ...
                  <div className="btn Btn2" onClick={handleCardDescription}>
                    Cancel
                  </div>
                </div>
              </>
            ...
            <div className="commentUser">
              <div className="Comments">
                ...
                <div className="comment">
                  <textarea
                    className="textarea commentData"
                    name=""
                        ...
                        for (let j = 0; j < toDoList[i].task.length; j++) {
                          if (toDoList[i].task[j].id === id) {
                            toDoList[i].task[j].comments.push({
                              ...
                              image:
                                "https://avatarfiles.alphacoders.com/127/thumb-127272.jpg",
                              comment: newComment,
                            });
                          }
                        }
            ...
            <div className="commentsHolder">
              {(comments !== null || undefined) && RemoveCounter <= comments ? (
                comments.length
              ) : null ? (
            ...
            <div className="Cardactions">
              {CardSettings.map((action) => (
                <>
                  ...
                  {Members && action.id === 1 && <MemberCard />}
                  {Cover && action.id === 2 && (
