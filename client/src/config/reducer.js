export let initialState = {
  ...
  users: [
    ...
    {
      photoURL:
        "https://i.pinimg.com/originals/4f/3c/76/4f3c7690241a8956f82c3611afeae4a0.jpg",
      id: "random2",
      job: "member",
      username: "リムル・テンペスト",
    },
  ...
  accounts: [
    ...
    {
      photoURL:
        "https://i.pinimg.com/originals/64/5b/c8/645bc8822281de496b8f7110b7568c57.jpg",
      id: "random3",
      job: "member",
      username: "Shido",
      added: false,
    ...
    {
      photoURL:
        "https://www.nautiljon.com/images/perso/00/39/kazuma_satou_13893.webp",
      id: "random4",
      job: "member",
      username: "Kazuma",
      added: false,
...
export const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "SET_NEW_BOARD_DESCRIPTION":
      return {
        ...state,
